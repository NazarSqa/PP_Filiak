...
namespace процес
{
    public partial class Form1 : Form
    {
        ...
        private void RefreshProcessesList() {
            ...
            Text = $"Заупщено процесів:" + processes.Count.ToString();
        ...
        private void RefreshProcessesList(List<Process> processes, string keyword)
        {
            try
            {
                ...
                Text = $"Заупщено процесів'{keyword}':" + processes.Count.ToString();
            }
            catch (Exception) { };
        }
        ...
        private void KillProcessAndChildren(int pid) {
            ...
            ManagementObjectSearcher searcher = new ManagementObjectSearcher(
                "Select * From Win32_Process Where PerentProcessID=" + pid);
        ...
        private void запуститиЗадачуToolStripMenuItem_Click(object sender, EventArgs e)
        {
            string path = Interaction.InputBox("Введіть имя програми", "Запуск нової задачі");
